  ...
  return (
    ...
    >
      ...
      <svg
        ...
        className="rail-sway w-4.5 sm:w-6.5 md:w-9.5 lg:w-14.5 xl:w-[clamp(70px,8vw,120px)]"
      ...
      >
        ...
        <path className="rp1" pathLength="1000"
        ...
        />
        <path className="rp2" pathLength="1000"
        ...
        />
        <path className="rp3" pathLength="1000"
      ...
      <svg
        viewBox="0 0 80 1000"
        preserveAspectRatio="none"
        className="rail-sway-r block w-4.5 sm:w-6.5 md:w-9.5 lg:w-14.5 xl:w-[clamp(70px,8vw,120px)]"
