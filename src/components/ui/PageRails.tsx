export default function PageRails() {
  return (
    ...
    >
      ...
      >
        {/* SMIL sway on the whole SVG — CSS can't block this */}
        <animateTransform
          attributeName="transform"
          attributeType="XML"
          type="translate"
          values="0 0; 12 0; -7 0; 14 0; 0 0"
        ...
        <defs>
          <linearGradient id="pg-l1" x1="0" y1="0" x2="0" y2="1000" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="44%"  stopColor="#5e0081" stopOpacity="0.52" />
            <stop offset="62%"  stopColor="#c080e0" stopOpacity="0.40" />
            <stop offset="80%"  stopColor="#5e0081" stopOpacity="0.48" />
          ...
          <linearGradient id="pg-l2" x1="0" y1="0" x2="0" y2="1000" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="15%"  stopColor="#e8c4ff" stopOpacity="0.28" />
            <stop offset="48%"  stopColor="#9b30d0" stopOpacity="0.32" />
            <stop offset="80%"  stopColor="#e8c4ff" stopOpacity="0.24" />
          ...
          <linearGradient id="pg-l3" x1="0" y1="0" x2="0" y2="1000" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="12%"  stopColor="#7b00aa" stopOpacity="0.36" />
            <stop offset="38%"  stopColor="#cc88ee" stopOpacity="0.32" />
            <stop offset="65%"  stopColor="#7b00aa" stopOpacity="0.42" />
          ...
          <linearGradient id="pg-l4" x1="0" y1="0" x2="0" y2="1000" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="20%"  stopColor="#bf7aff" stopOpacity="0.22" />
            <stop offset="55%"  stopColor="#5e0081" stopOpacity="0.24" />
            <stop offset="85%"  stopColor="#bf7aff" stopOpacity="0.18" />
        ...
        <path
          ...
          strokeDasharray="280 720" pathLength="1000"
        >
        ...
        <path
          ...
          strokeDasharray="240 760" pathLength="1000"
        >
          <animate attributeName="stroke-dashoffset" from="1000" to="0" dur="11s" begin="-2.5s" repeatCount="indefinite" />
        </path>
        <path
          ...
          strokeDasharray="260 740" pathLength="1000"
        >
          <animate attributeName="stroke-dashoffset" from="1000" to="0" dur="9s" begin="-5s" repeatCount="indefinite" />
        </path>
        <path
          d="M 66 150 C 28 245, 74 345, 30 468 C 10 562, 72 652, 26 768"
          fill="none" stroke="url(#pg-l4)" strokeWidth="1.5" strokeLinecap="round"
          strokeDasharray="200 800" pathLength="1000"
        >
          <animate attributeName="stroke-dashoffset" from="1000" to="0" dur="7s" begin="-1s" repeatCount="indefinite" />
        </path>
        <path
          d="M 14 580 C 62 655,  8 736, 58 816 C 76 876, 18 935, 60 990"
          fill="none" stroke="url(#pg-l3)" strokeWidth="1.8" strokeLinecap="round"
          strokeDasharray="180 820" pathLength="1000"
        >
      ...
      >
        ...
        <defs>
          <linearGradient id="pg-r1" x1="0" y1="0" x2="0" y2="1000" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="10%"  stopColor="#a07800" stopOpacity="0.38" />
            <stop offset="28%"  stopColor="#f0c040" stopOpacity="0.36" />
            <stop offset="48%"  stopColor="#a07800" stopOpacity="0.48" />
            <stop offset="66%"  stopColor="#f0c040" stopOpacity="0.34" />
            <stop offset="84%"  stopColor="#a07800" stopOpacity="0.44" />
          ...
          <linearGradient id="pg-r2" x1="0" y1="0" x2="0" y2="1000" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="18%"  stopColor="#ffe090" stopOpacity="0.26" />
            <stop offset="50%"  stopColor="#b88a00" stopOpacity="0.30" />
            <stop offset="82%"  stopColor="#ffe090" stopOpacity="0.22" />
          ...
          <linearGradient id="pg-r3" x1="0" y1="0" x2="0" y2="1000" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="10%"  stopColor="#c89600" stopOpacity="0.32" />
            <stop offset="35%"  stopColor="#f5d060" stopOpacity="0.30" />
            <stop offset="62%"  stopColor="#c89600" stopOpacity="0.40" />
            <stop offset="88%"  stopColor="#f5d060" stopOpacity="0.26" />
          ...
          <linearGradient id="pg-r4" x1="0" y1="0" x2="0" y2="1000" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="22%"  stopColor="#ffedb0" stopOpacity="0.20" />
            <stop offset="55%"  stopColor="#a07800" stopOpacity="0.22" />
            <stop offset="85%"  stopColor="#ffedb0" stopOpacity="0.16" />
        ...
        <path
          ...
          strokeDasharray="280 720" pathLength="1000"
        >
          <animate attributeName="stroke-dashoffset" from="1000" to="0" dur="9s" repeatCount="indefinite" />
        </path>
        <path
          ...
          strokeDasharray="240 760" pathLength="1000"
        >
          <animate attributeName="stroke-dashoffset" from="1000" to="0" dur="12s" begin="-3s" repeatCount="indefinite" />
        </path>
        <path
          ...
          strokeDasharray="260 740" pathLength="1000"
        >
          <animate attributeName="stroke-dashoffset" from="1000" to="0" dur="10s" begin="-6s" repeatCount="indefinite" />
        </path>
        <path
          ...
          strokeDasharray="200 800" pathLength="1000"
        >
          <animate attributeName="stroke-dashoffset" from="1000" to="0" dur="7.5s" begin="-1.5s" repeatCount="indefinite" />
        </path>
        <path
          ...
          strokeDasharray="180 820" pathLength="1000"
        >
          <animate attributeName="stroke-dashoffset" from="1000" to="0" dur="8.5s" begin="-4.5s" repeatCount="indefinite" />
        </path>
      </svg>
    </div>
  );
